...
parser.add_argument("--xml",type=bool,default=False,required=False,help="XML alignment element for BEAST")
...
dataset.write(path=args.o + ".temp",schema="nexus")
